...
int Date::daysTillYourBithday(Date birthdaydate)
{
    ...
    int curDay = str1.toInt();//день на компе
    int curMonth = str2.toInt();//месяц на компе
...
QString Date::boolToString(bool a)
{
    if(a)
    {
        return "Yes";
