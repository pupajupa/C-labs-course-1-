...
QT_MOC_LITERAL(1, 6, 11), // "signalOrder"
QT_MOC_LITERAL(2, 18, 0), // ""
QT_MOC_LITERAL(3, 19, 11), // "QMessageBox"
QT_MOC_LITERAL(4, 31, 18), // "on_doOrder_clicked"
QT_MOC_LITERAL(5, 50, 1) // "a"

    },
    "order\0signalOrder\0\0QMessageBox\0"
    "on_doOrder_clicked\0a"
};
...
void order::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->signalOrder((*reinterpret_cast< QMessageBox(*)>(_a[1]))); break;
        case 1: _t->on_doOrder_clicked((*reinterpret_cast< QMessageBox(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (order::*)(QMessageBox );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&order::signalOrder)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void order::signalOrder(QMessageBox _t1)
{
